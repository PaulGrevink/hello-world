...
* Use star to create a list
* Next item

> To create a text block, start with greater
then sign. To end add a blank line

A normal line between notes

> You can also insert hyperlinks, 
like [@paulgrevink](http://twitter.com/paulgrevink)
and more...
...
>See more below, copy and paste from Codeplay
